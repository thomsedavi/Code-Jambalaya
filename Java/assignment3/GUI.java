...
public abstract class GUI {
	...
	/**
	 * Is called when the Light Source button is pressed.
	 */
	protected abstract void onAddLightSource();

	/**
	 * Is called when the Reset Light Source button is pressed.
	 */
	protected abstract void resetLightSource();
	...
	private void initialise() {
		...
		//TODO
		JPanel lightsource = new JPanel();
		lightsource.setLayout(new BoxLayout(lightsource, BoxLayout.PAGE_AXIS));
		lightsource
		.setBorder(BorderFactory.createTitledBorder("Add Light"));
		...
		lightsource.add(addlight);

		JPanel resetLight = new JPanel();
		resetLight.setLayout(new BoxLayout(resetLight, BoxLayout.PAGE_AXIS));
		resetLight
		.setBorder(BorderFactory.createTitledBorder("Add Light"));

		JButton resetLights = new JButton("Reset Light");
		resetLights.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				resetLightSource();
			}
		...
		controls.add(lightsource);
		controls.add(Box.createVerticalGlue());
		controls.add(resetLight);
		controls.add(Box.createVerticalGlue());
